...
- **8081** (app-internal): НЕ е публикуван порт. Достъпен само в вътрешната мрежа. Използва се от app-public за извикване на вътрешния сървис.
- **5432** (postgres): НЕ е публикуван порт. Достъпен само в вътрешната мрежа. Използва се от app-public за достъп до базата данни.

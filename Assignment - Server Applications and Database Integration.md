# Курсов проект финален изпит: Сървърни приложения и Интеграция на бази данни
...
- Кодът трябва да бъде предаден като линк към GitLab на факултета, в съответното задание в Google Classroom.
